...
# Firm's Long Run Supply Decisions: Visualizing the Supply Curve
...
- Vertical intercept called the .shout["Choke price"]: price where $q_S=0$ ($10), just low enough to discourage *any* sales
...
| **Mathematically**: | $\epsilon_{q_s,p} > 1$ | $\epsilon_{q_D,p} = 1$ | $\epsilon_{q_D,p} < 1$ |
