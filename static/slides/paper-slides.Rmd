...
- Everything else is .onfire[secondary!]
...
- .onfire[Goal is to convince a **general reader**, **NOT** your professor]
...
- Arguments use .onfire[premises] and .onfire[reasoning] to support a .onfire[conclusion]
...
- .onfire[Nobody cares about how you feel, only what you can defend]
...
- .onfire[What are the actual institutions that affect individual behavior?]
  - e.g. statutes, laws, local customs, history, religious practices, community norms, shared values, morality

- .onfire[How do the conditions "on the ground" channel economic principles?]
...
.center[
![](https://www.dropbox.com/s/y34vcx6ejxljuhp/anecdotes.png?raw=1)
]
...
- Don't .onfire["cherry-pick"] that parts of examples that support your thesis and ignore parts that contradict it
...
- At the end of the day, no matter how technical, mathematical, or scientific, .onfire[every paper tells a story].
...
- .onfire[For all honest intellectual arguments, always ask yourself, what evidence, however improbable, would convince me of another view?]
...
- .onfire[Avoid repeating the introduction. Summarize it in half as many sentences if necessary]
...
- .onfire[As long as it needs to be (to do a good job).}
...
- At the very least, .onfire[assume your audience is an educated High School or college graduate] with some .onfire[basic familiarity with your subject area].
...
Remember, economics is *NOT* a narrow set of topics (e.g. inflation, stock prices, labor markets), it is a .onfire[way of thinking] about the world
