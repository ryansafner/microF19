...
.content-box-green[
.green[**Example**]: Suppose you run a bar in downtown Frederick, and estimate the demand for beer from undergraduates and graduates to be:
...
- Printer companies often sell printers at marginal cost (no markup) and sell the ink/refills at a much higher markup
