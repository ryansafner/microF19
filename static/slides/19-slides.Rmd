...
- .whisper[Arbitrage] opportunities: optimizing individuals recognize **profit opportunity**:
    - Buy at low price, resell at high price!
    - There are possible gains from trade or gains from innovation to be had
    
- .whisper[Entrepreneurship]: recognizing profit opportunities and entering a market as a seller to try to capture gains from trade/innovation
]
...
- Markets are .whisper[discovery processes] that *discover* the right prices, the optimal uses of resources, and cheapest production methods, none of which can be known in advance!
...
- .whisper[Resources are in the wrong place!]
...
- .whisper[We have the same stuff but different preferences]
...
- .whisper[We have the same stuff and/but different preferences]
...
2. Reach .whisper[equilibrium] (.whisper[prices are free to adjust]): absence of transactions costs or policies *preventing prices from adjusting* to meet supply and demand
