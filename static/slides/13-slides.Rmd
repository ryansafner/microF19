...
ggplot(data.frame(x=c(0,10)), aes(x=x))+
  stat_function(fun=mc_ex1, geom="line", size=2, color = "red")+
    geom_label(aes(x=5,y=mc_ex1(5)), color = "red", label=expression(MC(q)), size = 4)+
  stat_function(fun=avc_ex1, geom="line", size=2, color = "brown")+
    geom_label(aes(x=4,y=avc_ex1(4)), color = "brown", label=expression(AVC(q)), size = 4)+
  stat_function(fun=afc_ex1, geom="line", size=2, color = "pink")+
    geom_label(aes(x=5,y=afc_ex1(5)), color = "pink", label=expression(AFC(q)), size = 4)+
  stat_function(fun=ac_ex1, geom="line", size=2, color = "orange")+
    geom_label(aes(x=5,y=ac_ex1(5)), color = "orange", label=expression(AC(q)), size = 4)+
