...
# Cost $\rightarrow$ Opportunity Cost
...
2. Value is defined by .whisper[ordinal] concept 
...
3. Value inherently comes from the fact that we must make .whisper[tradeoffs]
    - Pursuing one objective means *not* pursuing others!
