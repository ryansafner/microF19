...
- If Incumbent sets $p_i>c$, then entrant would enter and set $p_e=p_i-\epsilon$ (for arbitrary $\epsilon>0)$
...
- In effect, sunk costs raise $c_e>c_i$, and return us back to the second example
