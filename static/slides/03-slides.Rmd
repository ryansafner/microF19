...
- .whisper[Economics revolves around (changes in) *relative* prices]
...
.center[
![:scale 90%](https://www.dropbox.com/s/9e7tx7dj47bsscz/scale.png?raw=1)
]
]
...
.center[
![:scale 85%](https://www.dropbox.com/s/9e7tx7dj47bsscz/scale.png?raw=1)
]
]
