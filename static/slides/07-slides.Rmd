...
- A consumer's .shout[quantity demanded] (of good x), $q_D^x$ is a function of their .shout[demand for good x], which depends on current market prices and their income
...
- If $\epsilon_{q,m}$ is *negative*: an .shout[inferior] good
...
- If $\epsilon_{q,m}$ is *negative*: an .shout[inferior] good
- If $\epsilon_{q,m}$ is *positive*: a .shout[normal] good
...
- Two subtypes of normal goods:
    - **Necessity**: $0 \leq \epsilon_{q,m} \leq 1$
        - $\uparrow$ quantity demanded as $\uparrow$ income (water, clothing)
