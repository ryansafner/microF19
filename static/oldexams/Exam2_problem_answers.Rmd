---
title: "Practice Exam 2 Answer Key"
author: "Ryan Safner"
output:
  pdf_document:
...
ggplot(data.frame(x=c(0,10)), aes(x=x))+
  stat_function(fun=isocost, geom="line", size=2, color = "red")+
    geom_label(aes(x=90,y=isocost(90)), color = "red", label="Cost=$2,000", size = 3)+
  stat_function(fun=isoquant, geom="line", size=2, color = "blue")+
    geom_label(aes(x=90,y=isoquant(90)), color = "blue", label="Output=1,000", size = 3)+
