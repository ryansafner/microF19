...
1. An upward-sloping market supply curve implies that the industry faces \emph{external diseconomies}.  

\vspace{2in}

2. A firm with the following production function
$$q=2l+k$$
has technology that exhibits *increasing returns to scale*.
...
4. A firm in a competitive market has lower costs than all of its competitors due to its having the best trained workers. In the long run, this firm can earn positive economic profits.
