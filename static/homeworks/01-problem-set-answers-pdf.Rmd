...
ggplot(data.frame(x=c(0,10)), aes(x=x))+
  stat_function(fun=IC_c1, geom="line", size=2, aes(color="IC_a1"))+
  geom_label(aes(x=8, y=IC_c1(8), color="IC_a1"), label=expression(IC[1]))+
  stat_function(fun=IC_c2, geom="line", size=2, aes(color="IC_a2"))+
  geom_label(aes(x=8, y=IC_c2(8), color="IC_a2"), label=expression(IC[2]))+
  stat_function(fun=IC_c3, geom="line", size=2, aes(color="IC_a3"))+
  geom_label(aes(x=8, y=IC_c3(8), color="IC_a3"), label=expression(IC[3]))+
  scale_x_continuous(breaks=seq(0,10,1),
                     limits=c(0,10),
                     expand=expand_scale(mult=c(0,0.1)))+
  scale_y_continuous(breaks=seq(0,10,1),
...
```{r}
ggplot(data.frame(x=c(0,10)), aes(x=x))+
  geom_segment(aes(x=2, xend=2, y=10, yend=1, color="IC_a1"), size=1)+
  geom_segment(aes(x=2, xend=10, y=1, yend=1, color="IC_a1"), size=1)+
  geom_label(aes(x=8, y=1, color="IC_a1"), label=expression(IC[1]))+
  geom_segment(aes(x=4, xend=4, y=10, yend=2, color="IC_a2"), size=1)+
  geom_segment(aes(x=4, xend=10, y=2, yend=2, color="IC_a2"), size=1)+
  geom_label(aes(x=8, y=2, color="IC_a2"), label=expression(IC[2]))+
  geom_segment(aes(x=6, xend=6, y=10, yend=3, color="IC_a3"), size=1)+
  geom_segment(aes(x=6, xend=10, y=3, yend=3, color="IC_a3"), size=1)+
  geom_label(aes(x=8, y=3, color="IC_a3"), label=expression(IC[3]))+
  scale_x_continuous(breaks=seq(0,10,1),
                     limits=c(0,10),
                     expand=expand_scale(mult=c(0,0.1)))+
  scale_y_continuous(breaks=seq(0,10,1),
...
```{r}
IC_e1=function(x){sqrt(36-x^2)}
IC_e2=function(x){sqrt(16-x^2)}
IC_e3=function(x){sqrt(4-x^2)}

ggplot(data.frame(x=c(0,10)), aes(x=x))+
  stat_function(fun=IC_e1, geom="line", size=2, aes(color="IC_a1"))+
  geom_label(aes(x=1, y=IC_e1(1), color="IC_a1"), label=expression(IC[1]))+
  stat_function(fun=IC_e2, geom="line", size=2, aes(color="IC_a2"))+
  geom_label(aes(x=1, y=IC_e2(1), color="IC_a2"), label=expression(IC[2]))+
  stat_function(fun=IC_e3, geom="line", size=2, aes(color="IC_a3"))+
  geom_label(aes(x=1, y=IC_e3(1), color="IC_a3"), label=expression(IC[3]))+
  scale_x_continuous(breaks=seq(0,10,1),
                     limits=c(0,10),
                     expand=expand_scale(mult=c(0,0.1)))+
  scale_y_continuous(breaks=seq(0,10,1),
...
ggplot(data.frame(x=c(0,10)), aes(x=x))+
  ...
  geom_label(aes(x=2, y=8, color="IC_a1"), label=expression(IC[1]))+
  geom_segment(aes(x=4, xend=4, y=0, yend=10), color="blue", size=2)+
  geom_label(aes(x=4, y=8, color="IC_a2"), label=expression(IC[2]))+
  geom_segment(aes(x=6, xend=6, y=0, yend=10), color="green", size=2)+
  geom_label(aes(x=6, y=8, color="IC_a3"), label=expression(IC[3]))+
  scale_x_continuous(breaks=seq(0,10,1),
                     limits=c(0,10),
                     expand=expand_scale(mult=c(0,0.1)))+
  scale_y_continuous(breaks=seq(0,10,1),
...
```{r}
ggplot(data.frame(x=c(0,10)), aes(x=x))+
  stat_function(fun=IC_e1, geom="line", size=2, aes(color="IC_a3"))+
  geom_label(aes(x=1, y=IC_e1(1), color="IC_a3"), label=expression(IC[3]))+
  stat_function(fun=IC_e2, geom="line", size=2, aes(color="IC_a2"))+
  geom_label(aes(x=1, y=IC_e2(1), color="IC_a2"), label=expression(IC[2]))+
  stat_function(fun=IC_e3, geom="line", size=2, aes(color="IC_a1"))+
  geom_label(aes(x=1, y=IC_e3(1), color="IC_a1"), label=expression(IC[1]))+
  scale_x_continuous(breaks=seq(0,10,1),
                     limits=c(0,10),
                     expand=expand_scale(mult=c(0,0.1)))+
  scale_y_continuous(breaks=seq(0,10,1),
