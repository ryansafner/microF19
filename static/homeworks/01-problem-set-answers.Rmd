...
- [<i class="fas fa-file-pdf"></i> `Download Answers as PDF`](/homeworks/01-problem-set-answers-pdf.pdf)
...
ggplot(data.frame(x=c(0,10)), aes(x=x))+
  stat_function(fun=IC_c1, geom="line", size=2, color="red")+
  geom_label(aes(x=8, y=IC_c1(8)), color="red", label=expression(IC[1]))+
  stat_function(fun=IC_c2, geom="line", size=2, color="blue")+
  geom_label(aes(x=8, y=IC_c2(8)), color="blue", label=expression(IC[2]))+
  stat_function(fun=IC_c3, geom="line", size=2, color="green")+
  geom_label(aes(x=8, y=IC_c3(8)), color="green", label=expression(IC[3]))+
  scale_x_continuous(breaks=seq(0,10,1),
                     limits=c(0,10),
                     expand=expand_scale(mult=c(0,0.1)))+
  scale_y_continuous(breaks=seq(0,10,1),
...
ggplot(data.frame(x=c(0,10)), aes(x=x))+
  stat_function(fun=IC_e1, geom="line", size=2, color="red")+
  geom_label(aes(x=1, y=IC_e1(1)), color="red", label=expression(IC[3]))+
  stat_function(fun=IC_e2, geom="line", size=2, color="blue")+
  geom_label(aes(x=1, y=IC_e2(1)), color="blue", label=expression(IC[2]))+
  stat_function(fun=IC_e3, geom="line", size=2, color="green")+
  geom_label(aes(x=1, y=IC_e3(1)), color="green", label=expression(IC[1]))+
  scale_x_continuous(breaks=seq(0,10,1),
                     limits=c(0,10),
                     expand=expand_scale(mult=c(0,0.1)))+
  scale_y_continuous(breaks=seq(0,10,1),
...
**Juan enjoys both music and fireworks. His income is $240 per week. Music streaming costs $12 per month, and fireworks cost $8 per bag.**
