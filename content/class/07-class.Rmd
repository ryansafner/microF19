...
Today, we look at how changes in *income* or changes in the prices of *other* goods can affect your quantity demanded for a good. If there is time, we may cover how changes in a good's (own) price may affect quantity demanded for that good. We introduce the idea of demand functions, inverse demand functions, and a demand curve.
