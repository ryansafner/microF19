...
ggplot(data.frame(x=c(0,10)), aes(x=x))+
  ...
  labs(x = "a",
       y = "b",
       title = "Optimal Consumption for Perfect Substitutes",
...
ggplot(data.frame(x=c(0,5)), aes(x=x))+
  ...
  labs(x = "x",
       y = "y",
       title = "Optimal Consumption for Perfect Complements",
...
These are the **demand functions** for goods $x$ and $y$. One of the **convenient properties** of Cobb-Douglas preferences is that a consumer *spends a constant fraction of income* $(\frac{a}{a+b})$ *on good $x$*, and *the complement fraction* $(\frac{b}{a+b})$ *on good $y$*!

This becomes especially simple when the exponents $a+b=1$, as in:

$$u(x,y)=x^ab^{(1-a)} \quad \quad \text{where 0 < a < 1}$$
...
and faces an income of $50$, $p_a=10$, $p_b=5$.
...
These are the **demand functions** for $x$ and for $y$. 