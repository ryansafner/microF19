...
ggplot(data.frame(x=c(0,10)), aes(x=x))+
  ...
  labs(x = "Output (q)",
       y = "Total Costs C(q)",
       title = "Total Costs with Constant Returns to Scale")+
  theme_classic(base_family = "Fira Sans Condensed", base_size=20)
```
...
ggplot(data.frame(x=c(0,10)), aes(x=x))+
  ...
  labs(x = "Output (q)",
       y ="Costs per Unit",
       title = "Per Unit Costs with Constant Returns to Scale")+
  theme_classic(base_family = "Fira Sans Condensed", base_size=20)
```
...
ggplot(data.frame(x=c(0,10)), aes(x=x))+
  ...
  labs(x = "Output (q)",
       y = "Total Costs C(q)",
       title = "Total Costs with Decreasing Returns to Scale")+
  theme_classic(base_family = "Fira Sans Condensed", base_size=20)
```
...
ggplot(data.frame(x=c(0,10)), aes(x=x))+
  ...
  labs(x = "Output (q)",
       y ="Costs per Unit",
       title = "Per Unit Costs with Decreasing Returns to Scale")+
  theme_classic(base_family = "Fira Sans Condensed", base_size=20)
```
...
ggplot(data.frame(x=c(0,10)), aes(x=x))+
  ...
  labs(x = "Output (q)",
       y = "Total Costs C(q)",
       title = "Total Costs with Increasing Returns to Scale")+
  theme_classic(base_family = "Fira Sans Condensed", base_size=20)
```
...
ggplot(data.frame(x=c(0,10)), aes(x=x))+
  ...
  labs(x = "Output (q)",
       y ="Costs per Unit",
       title = "Per Unit Costs with Increasing Returns to Scale")+
  theme_classic(base_family = "Fira Sans Condensed", base_size=20)
```
